...
public class BeanLifecycle {
    ...
    * Очищение ресурсов. Закрытие потоков ввода/вывода. Закрытие соединений с БД.*/
    public static void main(String[] args) {
        ...
        * названия. При создании бина, спринг берет и запускает метод inint который прописан в контексте и реализован
        ...
        * Конструктор, сеттер и геттер для спринга.
        * При создании объекта TestBeanLC. Происходит внедрение зависимости через сеттер.
        * Затем в инит методе он считает номер объекта и записывает его уже в поле объекта. Так как
